...
The main session acts as the central coordinator. Only one session may hold
the main role at a time. Agents must check who is main before taking
unilateral action.
...
Only a human user should claim the main session. Agents must never
self-elect.
